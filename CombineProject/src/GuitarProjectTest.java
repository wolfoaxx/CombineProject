...
public class GuitarProjectTest extends JFrame {
	...
	public GuitarProjectTest() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String filePath="C:\\Users\\yon\\git\\ProjectProgress3\\ProejctTest3\\test.txt";
				...
				JOptionPane.showMessageDialog(null, "Here Is Your Saved File","Guitar Learning System",
						JOptionPane.CLOSED_OPTION);
			}
		});
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Data Saved!","Guitar Learning System",
						JOptionPane.CLOSED_OPTION);
			}
		});
